...
export default function Dashboard() {
  ...
  return (
    <div className={styles.page}>
      <Head>
        <title>Turia.CASH - Home</title>
        <meta name="description" content="Fullstack digital wallet project" />
      ...
      <main className={styles.main}>
        <section className={styles.balance}>
          <div className={styles.balance__label}>
            ...
            <button type="button" title="Update" onClick={() => handleUpdateBalance(token)}>
              <GrUpdate />
            </button>
          </div>
